...
Gęstość występowania słów kluczowych w tekście wyrażona w procentach. 
Uwzględnia liczbę wystąpień każdego słowa kluczowego w stosunku do liczby wszystkich słów w tekście. 
Cecha to wartość liczbowa z zakresu [0; 1].

\subsubsection{Odległość słowa kluczowego od początku tekstu}
Odległość słów kluczowych od początku tekstu, która pozwoli zbliżyć się do określenia istotności słów kluczowych. 
Cecha to suma wartości liczbowych odzwierciedlających odległość danego słowa kluczowego od początku tekstu, 
gdzie pojedyncze słowo odpowiada odległości równej jeden.
\newline \newline
{\color{blue}

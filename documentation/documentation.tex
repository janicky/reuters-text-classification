    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            ybar interval=0.7,
                ...
                \legend{GSK, WSK, LWSK, OSK, LWS, PSK, SWSK, SODK, NWSK}
            \end{axis}

        \end{tikzpicture}
    \end{center}
    \caption{Poprawność klasyfikacji z wyłączeniem danej cechy}
...
\begin{figure}[h!]
    \begin{center}
        ...
        \end{tikzpicture}
    \end{center}
    \caption{Czas klasyfikacji z wyłączeniem danej cechy}
    \label{cecha_czas}
\end{figure}

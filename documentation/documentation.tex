...
\FloatBarrier
\subsection{Liczebność własnego zbioru}
...
\begin{figure}[h!]
    \begin{center}
        ...
        \end{tikzpicture}
    \end{center}
    \caption{Liczebność poszczególnych etykiet z własnego zbioru.}
    \label{licz_wlasny}
\end{figure}
...
\FloatBarrier
\subsection{Wyniki klasyfikacji dla kategorii $TOPICS$ dla ekstraktora TF}
...
\begin{figure}[h!]
    ...
    \end{center}
    \caption{Poprawność klasyfikacji dla wybranych wartości parametru $k$ i zawartych metryk dla
    kategorii $TOPICS$ dla ekstraktora TF.}
    \label{1_topics_tf}
\end{figure}
